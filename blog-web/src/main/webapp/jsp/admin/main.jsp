...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <div title="日志管理" data-options="iconCls:'icon-bkgl'" style="padding:10px;">
            <a href="javascript:openTab('写日志','writeBlog.html','icon-writeblog')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-writeblog'" style="width: 150px;">写日志</a>
            <a href="javascript:openTab('日志信息管理','blogManage.html','icon-bkgl')" class="easyui-linkbutton"
        ...
        <div title="日志类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
            <a href="javascript:openTab('日志类别信息管理','blogTypeManage.html','icon-bklb')" class="easyui-linkbutton"
        ...
        <div title="系统管理" data-options="iconCls:'icon-system'" style="padding:10px">
            ...
            <a href="https://www.revolvermaps.com/livestats/0xe1xtqrsrz/" target="_blank" class="easyui-linkbutton"
...
<div region="south" style="padding: 5px;height: 32px" align="center">
    <div style="width:450px;margin:0 auto;">
        <p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px;color:#939393;">Copyright &copy; 2019
            chenjianlink All Rights Reserved.</p>
    </div>
</div>
